  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      <div className="space-y-1">
        ...
        <p className="text-sm text-zinc-500 dark:text-zinc-400">Start your learning journey</p>
      </div>
      ...
      <div className="space-y-3">
        ...
        <label className="block space-y-1.5">
          ...
          <span className="text-xs text-zinc-400 dark:text-zinc-500">At least 8 characters</span>
        </label>
      </div>
