...
export default function LoginPage() {
  ...
  // Handle recovery token in URL hash (Supabase may redirect here instead of /update-password)
  useEffect(() => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      <div className="space-y-1">
        ...
        <p className="text-sm text-zinc-500 dark:text-zinc-400">Sign in to continue learning</p>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="text-right">
          <Link href="/reset-password" className="text-xs text-zinc-500 dark:text-zinc-400 hover:text-zinc-800 dark:hover:text-zinc-200">
            Forgot password?
          </Link>
        </div>
      </div>
